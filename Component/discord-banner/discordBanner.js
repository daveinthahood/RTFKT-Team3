const $discordBannerFirstWinner = document.querySelector(
  ".discord-banner-winner-first"
);
const $discordBannerSecondWinner = document.querySelector(
  ".discord-banner-winners-second"
); //  elemento su cui inserire l'hover
const $discordBannerThirdWinner = document.querySelector(
  ".discord-banner-winners-third"
); // elemento su cui inserire l'hover
const $discordBannerCenterImg = document.querySelector(
  ".discord-banner-center-image"
); // dove cambiare immagine
...
$discordBannerSecondWinner.addEventListener("mouseover", (event) => {
  ...
  if (target.classList.contains("discord-banner-winners-second")) {
    ...
    $myImg.src =
      "https://cdn.rtfkt.com/assets/images/creatorChallenge/creator2.png";
  }
});
...
$discordBannerSecondWinner.addEventListener("mouseleave", (event) => {
  ...
  if (target.classList.contains("discord-banner-winners-second")) {
    const id = target.dataset.id;
    $myImg.src =
      "https://cdn.rtfkt.com/assets/images/creatorChallenge/creator1.png";
  }
});
...
$discordBannerThirdWinner.addEventListener("mouseover", (event) => {
  ...
  if (target.classList.contains("discord-banner-winners-third")) {
    const id = target.dataset.id;
    $myImg.src =
      "https://cdn.rtfkt.com/assets/images/creatorChallenge/creator3.png";
  }
});
